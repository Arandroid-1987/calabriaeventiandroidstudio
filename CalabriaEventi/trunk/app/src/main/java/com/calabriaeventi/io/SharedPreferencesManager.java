...
public class SharedPreferencesManager {
    ...
    public LinkedList<Evento> getEventi(String key) {
        LinkedList<Evento> ris = new LinkedList<>();
        String json = sharedPreferences.getString(key, null);
        if (json != null) {
            try {
                Type type = new TypeToken<TimedObject<LinkedList<Evento>>>() {
                }.getType();
                TimedObject<LinkedList<Evento>> timedObject = gson.fromJson(json, type);
                if (timedObject.getDate().equals(Constants.TODAY)) {
                    ris = timedObject.getContent();
                }
    ...
    public void storeEventi(String key, LinkedList<Evento> eventi) {
        SharedPreferences.Editor editor = sharedPreferences.edit();
        TimedObject<LinkedList<Evento>> timedObject = new TimedObject<>(eventi);
