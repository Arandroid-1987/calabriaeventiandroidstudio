...
public class SlidingTabLayout extends HorizontalScrollView {
	...
	private boolean textColorAccent = true;
	...
	private void populateTabStrip() {
		...
		for (int i = 0; i < adapter.getCount(); i++) {
			...
			if (context instanceof Activity) {
				...
				activity.getTheme().resolveAttribute(resource, color,
						true);
	...
	public void useTextColorAccent(boolean textColorAccent) {
		this.textColorAccent = textColorAccent;
	}
